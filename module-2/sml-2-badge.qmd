...
The final activity for each lab provides space to work with data and to reflect on how the concepts and techniques introduced in each lab might apply to your own research.
...
In this part of the badge activity, please add another variable as a **third predictor** from the IPEDS data set. By adding it, you'll be able to examine how much *more accurate* your model is (if at all, as this variable might not have great predictive power).
