...
students <- students %>% 
    ...
    mutate(pass = factor(pass, levels = c("1", "0"))) # makes the variable a factor with "1" (pass) as the first level
...
| Accuracy                                  |                                                                                                                                             |
| Sensitivity (AKA recall)                  | The model correctly predicts about 43% of students who pass correctly (as passing). This is quite low and could be improved.                |
| Specificity                               | The model correctly predicts about 2/3 of students who do not pass correctly (as not passing). This is pretty good, but it could be better. |
